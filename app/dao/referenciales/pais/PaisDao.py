...
class PaisDao:
        ...
        try:
            ...
            if paisEncontrada:
                return {
                    ...
                    }  # Retornar los datos de la pais
            else:
                return None # Retornar None si no se encuentra la pais
        except Exception as e:
    ...
    def guardarPais(self, descripcion):
        ...
        insertPaisSQL = """
        INSERT INTO pais(descripcion) VALUES(%s) RETURNING id
        """
