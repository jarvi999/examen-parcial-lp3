...
def addPais():
    ...
    try:
        ...
        if pais_id is not None:
            ...
            return jsonify({ 'success': False, 'error': 'No se pudo guardar la pais. Consulte con el administrador.' }), 500
    except Exception as e:
...
def deletePais(pais_id):
    ...
    try:
        ...
        if paisdao.deletePais(pais_id):
            ...
            return jsonify({
                'success': False,
                'error': 'No se encontró la pais con el ID proporcionado o no se pudo eliminar.'
            }), 404
