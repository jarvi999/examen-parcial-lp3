...
ocupacionapi = Blueprint('ocupacionapi', __name__)

# Trae todas las ocupaciones
@ocupacionapi.route('/ocupaciones', methods=['GET'])
def getOcupaciones():
...
@ocupacionapi.route('/ocupaciones/<int:ocupacion_id>', methods=['GET'])
...
@ocupacionapi.route('/ocupaciones', methods=['POST'])
def addOcupacion():
...
@ocupacionapi.route('/ocupaciones/<int:ocupacion_id>', methods=['PUT'])
...
@ocupacionapi.route('/ocupaciones/<int:ocupacion_id>', methods=['DELETE'])
